...
declare function serializeRequest$k(request: GetWalletNFTCollectionsRequest, core: Core): {
    ...
    cursor: string | undefined;
    address: string;
    exclude_spam: boolean | undefined;
};
...
interface GetWalletNFTTransfersRequest extends Camelize<Omit<RequestParams$i, 'chain' | 'address' | 'from_date' | 'to_date'>> {
    chain?: EvmChainish;
    address: EvmAddressish;
    fromDate?: DateInput;
    toDate?: DateInput;
